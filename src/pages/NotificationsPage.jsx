                    ...
                    <div className="mb-8">
                        ...
                        <div className="space-y-4">
                            {pendingRequests.map((request) => {
                                ...
                                const urgency = urgencyColors[request.urgency] || urgencyColors.MEDIUM;
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center text-white font-bold text-lg">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-0.5">
                                                        <span className="px-2 py-0.5 bg-red-50 dark:bg-red-950/30 text-red-600 text-xs font-bold rounded-full">
                                                            {sender.bloodGroup}
                                                        </span>
                                                        <span className="text-xs text-gray-500">
                                                            {sender.age} yrs • {sender.gender}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* Urgency Badge */}
                                            <span className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border ${urgency.bg} ${urgency.text} ${urgency.border}`}>
                                        ...
                                        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mb-4">
                                            <div className="flex items-center gap-2 mb-3">
                                                <IconDroplet className="w-5 h-5 text-red-500" />
                                                <span className="font-bold text-gray-900 dark:text-white">
                                                    Needs {request.bloodGroupNeeded}
                                                </span>
                                            ...
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm text-gray-700 dark:text-gray-300">
                                                    ...
                                                    {request.reasonOther && ` - ${request.reasonOther}`}
                                                </span>
                                            </div>
                                            ...
                                            {request.patientName && (
                                                <div className="flex items-center gap-2 mb-2">
                                                    ...
                                                    <span className="text-sm text-gray-700 dark:text-gray-300">
                                                        ...
                                                        {request.patientAge && `, ${request.patientAge} yrs`}
                                            ...
                                            {request.hospitalName && (
                                                <div className="flex items-center gap-2 mb-2">
                                                    <IconHospital className="w-4 h-4 text-emerald-500" />
                                                    <span className="text-sm text-gray-700 dark:text-gray-300">
                                                        <span className="font-medium">{request.hospitalName}</span>
                                                        {request.hospitalAddress && `, ${request.hospitalAddress}`}
                                                    </span>
                                                </div>
                                            )}
                                            ...
                                            {request.requiredDate && (
                                                <div className="flex items-center gap-2 mb-2">
                                                    ...
                                                    <span className="text-sm text-gray-700 dark:text-gray-300">
                                                        <span className="font-medium">Need by:</span> {formatDate(request.requiredDate)}
                                                    </span>
                                                </div>
                                            )}
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <a href={`tel:${request.contactNumber}`} className="text-sm font-semibold text-green-600 hover:text-green-700">
                                        ...
                                        {/* Message */}
                                        {request.message && (
                                            <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-950/20 rounded-xl border border-blue-100 dark:border-blue-900/30">
                                                <div className="flex items-start gap-2">
                                                    <IconMessage className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                                        ...
                                        {request.additionalNotes && (
                                            <div className="mb-4 text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 rounded-lg p-2">
                                                <span className="font-medium">Notes:</span> {request.additionalNotes}
                                            </div>
                                        )}

                                        {/* Sender Location & Time */}
                                        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mb-4">
                                            <div className="flex items-center gap-1">
                                                <IconMapPin className="w-3 h-3" />
                                                {sender.upazila ? `${sender.upazila}, ` : ''}{sender.district}
                                            </div>
                                            <div className="flex items-center gap-1">
                                        ...
                                        <div className="flex gap-3">
                                            <button
                                                ...
                                                disabled={isUpdating}
                                                className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-semibold transition shadow-sm hover:shadow-emerald-500/25 disabled:opacity-50"
                                            >
                                            ...
                                            <button
                                                ...
                                                disabled={isUpdating}
                                                className="px-6 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl text-sm font-semibold transition border border-gray-200 dark:border-gray-700 disabled:opacity-50"
                                            >
                                                Decline
                                            </button>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-gray-500">
                                                    Needs {request.bloodGroupNeeded} • {request.reason} • {request.contactNumber}
                                                </p>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-gray-500">
                                                    Needs {request.bloodGroupNeeded} • {request.reason}
                                                </p>
                                                <p className="text-xs text-gray-400">
                                                    Declined {formatTime(request.updatedAt)}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                {requests.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            When someone needs blood, you'll see their request here.
                        </p>
                    </div>
                )}
            </div>
